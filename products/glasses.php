...
// Get stock quantity for glasses product
$stmt = $pdo->prepare("SELECT stock_quantity FROM products WHERE name = 'Legacy Pilot Square Sunglasses'");
$stmt->execute();
...
<head>
    ...
    <title>TRÈS CHIC | Legacy Pilot Square Sunglasses</title>
...
<body class="bg-white text-black transition-colors duration-200">
    ...
    <main class="grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        <div class="bg-gray-50 flex justify-center items-center p-8">
            <img src="../Images/glassesinner.png" alt="Legacy Pilot Square Sunglasses" class="w-full h-auto max-h-[90vh] object-contain" />
        </div>
    
        <!-- Product Info -->
        <div class="p-10 flex flex-col justify-center items-start">
            <div class="w-full max-w-md">
                <p class="text-xs tracking-widest mb-1">7GLPS2</p>
                <h1 class="text-3xl font-semibold mb-2">Legacy Pilot Square Sunglasses</h1>
                <p class="text-lg mb-3"> $ 150.00</p>
                ...
                <!-- Buttons -->
                <button onclick="addToCartWithQuantity('7GLPS2', 'Legacy Pilot Square Sunglasses', 150.00, '../Images/glassesinner.png')" class="bg-black text-white py-3 rounded-full text-center w-full text-sm font-medium hover:bg-gray-800 transition mb-2">
                    Place in Cart
                </button>
                ...
                <div class="text-sm text-gray-700 leading-relaxed">
                    <p class="mb-2">
                        Les lunettes de soleil Legacy Pilot Square allient style aviateur classique et design contemporain. Monture en métal premium avec verres traités anti-UV et branches ergonomiques pour un confort optimal.
                    </p>
                ...
                <div class="mt-10 text-sm border-t pt-4">
                    <details class="mb-2">
                        ...
                        <p class="mt-2 text-gray-600">Nettoyer avec le chiffon en microfibre fourni. Conserver dans l'étui rigide. Éviter l'exposition aux produits chimiques.</p>
                    </details>
                    <details>
