...
// Get stock quantity for vest product
$stmt = $pdo->prepare("SELECT * FROM products WHERE product_id = '7'");
$stmt->execute();
$product = $stmt->fetch(PDO::FETCH_ASSOC);
$stock_quantity = $product ? $product['stock_quantity'] : 0;
$productId = $product ? $product['product_id'] : '7';
$productName = $product ? $product['name'] : 'Elegant Vest';
$productPrice = $product ? $product['price'] : 1280.00;
...
<head>
    ...
    <title>TRÈS CHIC | Gilet Matelassé</title>
...
<body class="bg-white text-black transition-colors duration-200">
    ...
    <main class="grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        <div class="bg-gray-50 flex justify-center items-center p-8">
            <img src="../Images/vest inner1.png" alt="Gilet Matelassé" class="w-full h-auto max-h-[90vh] object-contain" />
        </div>
        ...
        <div class="p-10 flex flex-col justify-center items-start">
            <div class="w-full max-w-md">
                ...
                <!-- Buttons -->
                <button onclick="addToCartWithQuantity('<?php echo $productId; ?>', '<?php echo $productName; ?>', <?php echo $productPrice; ?>, './Images/vest inner1.png')" 
                ...
                <div class="text-sm text-gray-700 leading-relaxed">
                    <p class="mb-2">
                        Ce gilet matelassé réversible allie style et fonctionnalité. D'un côté, un motif signature élégant, de l'autre, une finition unie sophistiquée. La doublure en soie et le rembourrage en duvet offrent un confort optimal.
                    </p>
                ...
                <div class="mt-10 text-sm border-t pt-4">
                    <details class="mb-2">
                        ...
                        <p class="mt-2 text-gray-600">Nettoyage à sec uniquement. Ne pas repasser directement sur les motifs.</p>
                    </details>
                    <details>
