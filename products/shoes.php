...
// Get stock quantity for shoes product
$stmt = $pdo->prepare("SELECT stock_quantity FROM products WHERE name = 'Mocassins Classiques'");
$stmt->execute();
...
<head>
    ...
    <title>TRÈS CHIC | Mocassins Classiques</title>
...
<body class="bg-white text-black transition-colors duration-200">
    ...
    <main class="grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        <div class="bg-gray-50 flex justify-center items-center p-8">
            <img src="../Images/shoes inner.png" alt="Mocassins Classiques" class="w-full h-auto max-h-[90vh] object-contain" />
        </div>
    
        <!-- Product Info -->
        <div class="p-10 flex flex-col justify-center items-start">
            <div class="w-full max-w-md">
                <p class="text-xs tracking-widest mb-1">4MCSS7</p>
                <h1 class="text-3xl font-semibold mb-2">Mocassins Classiques</h1>
                <p class="text-lg mb-3">$ 1,110.00</p>
                ...
                <!-- Buttons -->
                <button onclick="addToCartWithQuantity('4MCSS7', 'Mocassins Classiques', 1110.00, '../Images/shoes inner.png')" class="bg-black text-white py-3 rounded-full text-center w-full text-sm font-medium hover:bg-gray-800 transition mb-2">
                    Place in Cart
                </button>
                ...
                <div class="text-sm text-gray-700 leading-relaxed">
                    <p class="mb-2">
                        Ces mocassins classiques incarnent l'élégance italienne. Confectionnés en cuir de veau souple avec une semelle en cuir, ils offrent un confort exceptionnel et une allure sophistiquée.
                    </p>
                ...
                <div class="mt-10 text-sm border-t pt-4">
                    <details class="mb-2">
                        ...
                        <p class="mt-2 text-gray-600">Nettoyer avec une brosse douce. Utiliser un cirage de qualité. Protéger de l'humidité.</p>
                    </details>
                    <details>
