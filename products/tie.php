...
// Get stock quantity for tie product
$stmt = $pdo->prepare("SELECT stock_quantity FROM products WHERE name = 'Monogram Wildflowers Tie'");
$stmt->execute();
...
<head>
    ...
    <title>TRÈS CHIC | Monogram Wildflowers Tie</title>
...
<body class="bg-white text-black transition-colors duration-200">
    ...
    <main class="grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        <div class="bg-gray-50 flex justify-center items-center p-8">
            <img src="../Images/tie inner.png" alt="Monogram Wildflowers Tie" class="w-full h-auto max-h-[90vh] object-contain" />
        </div>
    
        <!-- Product Info -->
        <div class="p-10 flex flex-col justify-center items-start">
            <div class="w-full max-w-md">
                <p class="text-xs tracking-widest mb-1">5TMNW3</p>
                <h1 class="text-3xl font-semibold mb-2">Monogram Wildflowers Tie</h1>
                <p class="text-lg mb-3">$ 345.00</p>
                ...
                <!-- Buttons -->
                <button onclick="addToCartWithQuantity('5TMNW3', 'Monogram Wildflowers Tie', 345.00, '../Images/tie inner.png')" class="bg-black text-white py-3 rounded-full text-center w-full text-sm font-medium hover:bg-gray-800 transition mb-2">
                    Place in Cart
                </button>
                ...
                <div class="text-sm text-gray-700 leading-relaxed">
                    <p class="mb-2">
                        Cette cravate en soie jacquard présente un motif Monogram Wildflowers exclusif. Sa finition mate et sa doublure en soie offrent une élégance raffinée pour toutes les occasions formelles.
                    </p>
                ...
                <div class="mt-10 text-sm border-t pt-4">
                    <details class="mb-2">
                        ...
                        <p class="mt-2 text-gray-600">Nettoyage à sec uniquement. Conserver sur un cintre adapté. Éviter l'exposition prolongée à la lumière.</p>
                    </details>
                    <details>
