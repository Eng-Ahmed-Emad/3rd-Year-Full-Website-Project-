...
// Get stock quantity for belt product
$stmt = $pdo->prepare("SELECT stock_quantity FROM products WHERE name = 'Pont Neuf 35mm Belt'");
$stmt->execute();
...
<head>
    ...
    <title>TRÈS CHIC | Pont Neuf 35mm Belt</title>
...
<body class="bg-white text-black transition-colors duration-200">
    ...
    <div id="slidingMenu" class="sliding-menu">
        <div class="menu-content">
            ...
            <div class="menu-item" onclick="window.location.href='../cart.php'">
    ...
    <main class="grid grid-cols-1 md:grid-cols-2 min-h-screen">
        ...
        <div class="bg-gray-50 flex justify-center items-center p-8">
            <img src="../Images/belt inner.png" alt="Pont Neuf 35mm Belt" class="w-full h-auto max-h-[90vh] object-contain" />
        </div>
    
        <!-- Product Info -->
        <div class="p-10 flex flex-col justify-center items-start">
            <div class="w-full max-w-md">
                <p class="text-xs tracking-widest mb-1">6BPN35</p>
                <h1 class="text-3xl font-semibold mb-2">Pont Neuf 35mm Belt</h1>
                <p class="text-lg mb-3">$ 975.00</p>
                ...
                <!-- Buttons -->
                <button onclick="addToCartWithQuantity('6BPN35', 'Pont Neuf 35mm Belt', 975.00, '../Images/belt inner.png')" class="bg-black text-white py-3 rounded-full text-center w-full text-sm font-medium hover:bg-gray-800 transition mb-2">
                    Place in Cart
                </button>
                ...
                <div class="text-sm text-gray-700 leading-relaxed">
                    <p class="mb-2">
                        La ceinture Pont Neuf 35mm incarne l'élégance classique. Fabriquée en cuir de veau souple avec une boucle en métal palladié, elle allie style intemporel et savoir-faire artisanal.
                    </p>
                ...
                <div class="mt-10 text-sm border-t pt-4">
                    <details class="mb-2">
                        ...
                        <p class="mt-2 text-gray-600">Nettoyer avec un chiffon doux légèrement humide. Éviter l'exposition prolongée à l'humidité. Ranger à plat dans son étui.</p>
                    </details>
                    <details>
